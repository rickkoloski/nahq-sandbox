...
function AISummaryCard({ cohorts }) {
  ...
  return (
    <motion.div
      ...
      className="mb-8 relative overflow-hidden rounded-2xl bg-white border border-gray-200 shadow-sm"
    >
      <div className="relative z-10 flex items-start gap-4 p-6">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">AI Assessment Overview</p>
          <div className="space-y-1.5">
            {insights.map((insight, i) => (
              <div key={i} className="flex items-start gap-2 text-sm text-gray-700 font-medium leading-relaxed">
                <div className="w-1 h-1 rounded-full bg-[#00A3E0] mt-2 flex-shrink-0" />
                <span>{insight}</span>
              </div>
            ))}
          </div>
        ...
        <div className="hidden sm:flex flex-col items-center gap-1 text-center flex-shrink-0">
          ...
          <div className="text-xs text-gray-500 uppercase tracking-wide font-semibold">Overall completion</div>
        </div>
      </div>
    </motion.div>
  );
    ...
    >
      ...
      >
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <div>
            <h2 className="text-lg font-semibold text-[#3D3D3D]">Send Assessment Reminder</h2>
            <p className="text-xs text-gray-500 mt-0.5">{notStartedUsers.length} participants have not completed their assessment</p>
          </div>
            ...
            {totalPages > 1 && (
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="w-7 h-7 rounded-lg border border-gray-200 flex items-center justify-center text-gray-500 hover:bg-gray-100 disabled:opacity-30 disabled:cursor-not-allowed"
                >
                  <ChevronLeft className="w-4 h-4" />
                </button>
                <span className="text-xs text-gray-500">{cohortPage + 1} / {totalPages}</span>
                <button
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-6">
              ...
              {notStarted.length > 0 && selectedCohort.status !== 'closed' && (
                ...
                >
                  ...
                  Notify Non-Completers ({notStarted.length})
                </Button>
              )}
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6">
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
                <p className="text-xs text-gray-500 mb-1 uppercase tracking-wide">Enrolled</p>
              ...
              <div className="bg-[#ECFDF3] rounded-lg p-4 border border-green-100">
                <p className="text-xs text-gray-500 mb-1 uppercase tracking-wide">Completed</p>
                <p className="text-2xl font-bold text-[#12B76A]">{completed.length}</p>
              </div>
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
                <p className="text-xs text-gray-500 mb-1 uppercase tracking-wide">Not Started</p>
                <p className="text-2xl font-bold text-[#667085]">{notStarted.length}</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
                <div className="h-full bg-[#12B76A] transition-all rounded-full" style={{ width: `${completionRate}%` }} />
              </div>
            </div>
          </div>
              ...
              <div className="flex flex-wrap items-center gap-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-9 pr-3 py-2 text-sm border border-gray-200 rounded-lg bg-gray-50 focus:outline-none focus:border-[#3D3D3D] w-52"
                  />
                </div>
                <select
                  value={statusFilter}
                  onChange={e => setStatusFilter(e.target.value)}
                  className="text-sm border border-gray-200 rounded-lg px-3 py-2 bg-gray-50 text-[#3D3D3D] focus:outline-none focus:border-[#3D3D3D]"
                >
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-100">
                    ...
                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide">Role Group</th>
