      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              <Label htmlFor="organizationSize" className="text-sm font-medium text-gray-700 mb-2 block">
                Organization Size
              </Label>
              <Select value={formData.organizationSize} onValueChange={(value) => handleChange('organizationSize', value)}>
                <SelectTrigger className="border-gray-200">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
