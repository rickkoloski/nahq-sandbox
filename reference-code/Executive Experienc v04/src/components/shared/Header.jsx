...
import { FileText, BookOpen, User, HelpCircle, ChevronDown, Menu, X } from 'lucide-react';
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                ...
                <DropdownMenuItem asChild>
                  <Link to={createPageUrl('OrganizationalFramework')} className="flex items-center gap-2">
                    <BookOpen className="w-4 h-4" />
                    Framework
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link to={createPageUrl('ExecutiveOverview')} className="flex items-center gap-2">
                    <FileText className="w-4 h-4" />
                    Executive Overview
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link to={createPageUrl('ExecutiveDashboard')} className="flex items-center gap-2">
                    <FileText className="w-4 h-4" />
                    Executive Dashboard
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link to={createPageUrl('AssessmentTracking')} className="flex items-center gap-2">
                    <FileText className="w-4 h-4" />
                    Assessment Tracking
                  </Link>
                </DropdownMenuItem>
